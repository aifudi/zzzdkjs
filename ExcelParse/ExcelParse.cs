...
namespace ExcelParseNS
{
    ...
    public class ExcelParse
    {
        ...
        private void DataInit()
        {
            ...
            var records = GetDataFromExcelByCom(true);
        ...
        /// </summary>
        /// <returns></returns>
        public bool EditNewRecord(FiberRecord oldrec, FiberRecord newrec)
        {
            return false;
        }
                ...
                for (int iCol = 1; iCol <= iColCount; iCol++)
                {
                    ...
                    switch (txt2)
                    {
                        case "序号":
                            ...
                            break;
                        case "运营商":
                            worksheet.Cells[rowIdx, iCol] = rec.TeleOperator;  //光纤承建运营商
                            break;
                        case "光纤尾号":
                            worksheet.Cells[rowIdx, iCol] = rec.FiberPigtail;  //光纤承建运营商
                            break;
                        case "远端地址":
                            worksheet.Cells[rowIdx, iCol] = "just a test";  //光纤承建运营商
                            break;
                    }
        ...
        /// <returns></returns>
        public List<FiberRecord> GetDataFromExcelByCom(bool hasTitle = true)
        {
            Excel.Application app = new Excel.Application();
            Excel.Sheets sheets;
            object oMissiong = System.Reflection.Missing.Value;
...
//        /// <param name="hasTitle"></param>
//        /// <returns></returns>
//        public List<FiberRecord> GetDataFromExcelByCom(bool hasTitle = false)
//        {
//            try
//            {
//                //将数据读入到DataTable中
